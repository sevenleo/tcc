...
file='text8'
file='macr12.txt'
#word2vec.word2phrase('w2v/'+file, 'w2v/'+file+'-phrases', verbose=True)
#word2vec.word2vec('w2v/'+file+'-phrases', 'w2v/'+file+'.bin', size=100, verbose=True)
#word2vec.word2clusters('w2v/'+file, 'w2v/'+file+'-clusters.txt', 100, verbose=True)



########## Predictions
model = word2vec.load('w2v/'+file+'.bin', encoding = "ISO-8859-1")
#model.vocab
#model.vectors.shape
#model.vectors
#model['dog'].shape
#model['dog'][:10]
palavra='noite'
indexes, metrics = model.cosine(palavra)
#model.vocab[indexes]
#model.generate_response(indexes, metrics)
print ( "model.cosine('"+palavra+"')" )
...
########## Clusters
clusters = word2vec.load_clusters('w2v/text8-clusters.txt')
clusters['dog']
